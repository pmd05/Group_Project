...
namespace HairSalonBookingApp
{
    public partial class MainForm : Form
    {
        ...
        {
            MessageBox.Show("Hãy đăng nhập trước!", "Information Message", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
        ...
        private void main_name_TextChanged(object sender, EventArgs e)
        {
        ...
        private void main_phone_TextChanged(object sender, EventArgs e)
        {
